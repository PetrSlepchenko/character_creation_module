...
def attack(char_name: str, char_class: str) -> str:
    """Вычисляет силу удара в зависимости от должности."""
...
def defence(char_name: str, char_class: str) -> str:
    """Вычисляет размер урона в зависимости от должности."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Определяет применение специального умения в зависимости от должности"""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Предлагает игроку выбор действий."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Предлагает игроку выбор профессии."""
